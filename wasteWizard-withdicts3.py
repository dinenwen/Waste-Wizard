def main():
    global city
    city = input ('Welcome to Waste Wizard. This program teaches you how to sort your trash based on your city. Right now we are in San Francisco')
##    eventually we will have dictionaries for more cities. 
##    city = city.upper()
...
def items(item):
    ...
    item_responses = {
        ...
        'LANDFILL': 'Oh no, your %(item)s is LANDFILL. Place it in the black bin.',
